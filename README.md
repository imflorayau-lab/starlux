...
|[影像管理後台](https://imflorayau-lab.github.io/starlux/SJX_DTMS_20260526.html) | 2026.05.26|增加<br>1. 報單上傳；<br>2.系統管理>接收文件代碼<br>3. 外運調整Note欄位顯示。按編號可以看內容<br>4. 報單與接收拆開<br>5. 接收文件、移倉
國內/進口拆開<br>6. 調閱紀錄|
